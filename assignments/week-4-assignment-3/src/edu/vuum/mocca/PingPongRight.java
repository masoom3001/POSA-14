...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore mSimpleSemas[] = new SimpleSemaphore[2]; 
        /**
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	mSimpleSemas[FIRST_SEMA] = semaphoreOne;
        	mSimpleSemas[SECOND_SEMA] = semaphoreTwo;
        ...
        public void run() {
            ...
            // TODO - You fill in here.
        	try{
        		for(int loopDone = 1; loopDone <= mMaxLoopIterations; loopDone++)
        		{
        			acquire();
        ...
        private void acquire() {
            // TODO fill in here
        	mSimpleSemas[FIRST_SEMA].acquireUninterruptibly();
        }
        ...
        private void release() {
            // TODO fill in here
        	mSimpleSemas[SECOND_SEMA].release();
        }
    }
